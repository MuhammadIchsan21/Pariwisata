    ...
    <div style="background-color:#e4e6eb;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:150px;">
                                                            <img alt="" height="auto"
                                                                src="{{url('assets/images/SmartRT-Resize.png')}}"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                jangan Lupakan Tiket Digital mu!</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
      ...
      <![endif]-->
        ...
        <![endif]-->
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr>
                                                    <td style="width: 50px">
                                                        <img src="{{url('assets/images/SmartRT-Resize.png')}}"
                                                            width="50px" />
                                                    </td>
                                                    <td style="
								font-size: 18px;
							...
							"> ichsanteratai@gmail.com<br /> 0856-0328-9206 </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
